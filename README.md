...
<img src="./.readme/screen/01-overview.png" width="880" alt="Use a dedicated Latest data view with sortable columns while keeping the familiar Zabbix filters and actions.">
...
A second Latest data page where Last value is a real sortable column - top consumers in one click.
...
<table>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/02-sorted-desc.png" alt="Sorted desc"><br><small><b>Sorted desc</b> - Sort monitored items by Last value to bring the largest or smallest readings to the top immediately.</small></td>
</tr>
</table>
...
| Feature | FREE |
| ---------------------------------------------------------- | :----: |
| Second Latest data page with Last value as a sortable column | ✅ |
| Ascending and descending, like every other Zabbix list | ✅ |
| Same filter, saved filter tabs, subfilters and context menus | ✅ |
