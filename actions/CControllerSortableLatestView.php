...
/**
 * Controller for the "Sortable Latest data" page.
 */
class CControllerSortableLatestView extends CControllerSortableLatest {
	...
	protected function doAction(): void {
		...
		$refresh_curl_params = ['action' => 'sortable.latest.view.refresh'] + $filter;
		...
		$response->setTitle(_('Sortable Latest data'));
